...
public class HolidaysController {
    ...
    public String displayHolidays(@RequestParam(required = false) boolean festival,
        ...
        model.addAttribute("federal", federal); //false //the purpose of adding inputs to the model is: we can send them back again to our holidays.html page,
        // inside our holidays.html we have some if-else conditions saying: ONly if this attribute is true/false and display the content accordingly.
        List<Holiday> holidays = Arrays.asList(
                new Holiday(" Jan 1 ", "New Year's Day", Holiday.Type.FESTIVAL),
                new Holiday(" Oct 31 ", "Halloween", Holiday.Type.FESTIVAL),
                new Holiday(" Nov 24 ", "Thanksgiving Day", Holiday.Type.FESTIVAL),
